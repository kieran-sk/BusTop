            ...
            return `
              <div class="m3-card" style="display: flex; align-items: center; justify-content: space-between; gap: 0.75rem; padding: 0.85rem 1rem; margin-bottom: 0; cursor: pointer; background: var(--md-sys-color-surface-container); border: 1px solid var(--md-sys-color-outline-variant); border-left: 3.5px solid var(--md-sys-color-primary);" onclick="window.App.selectStop('${s.code}', '${safeName}', '${s.lat || ''}', '${s.lng || ''}')">
                <div style="display: flex; align-items: center; gap: 0.75rem; min-width: 0; flex: 1;">
                  <div class="m3-icon-btn" style="width: 36px; height: 36px; background: #1e293b; color: var(--md-sys-color-primary); border: 1.5px solid #3b82f6; flex-shrink: 0;">
            ...
            return `
              <div class="m3-card" style="display: flex; flex-direction: column; gap: 0.6rem; padding: 0.85rem 1rem; margin-bottom: 0; cursor: pointer; background: var(--md-sys-color-surface-container); border: 1px solid var(--md-sys-color-outline-variant); border-left: 3.5px solid #10b981;" onclick="window.App.openLineTimetableBothDirections('${l.code}', '${l.id}', '${safeDescr}')">
                ...
                <div style="display: flex; align-items: center; justify-content: flex-end; border-top: 1px dashed var(--md-sys-color-outline-variant); padding-top: 0.4rem;">
                  <span class="m3-badge" style="background: #064e3b; color: #6ee7b7; font-size: 0.75rem; font-weight: 800; padding: 3px 10px; border-radius: 9999px;">
